...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <Media src="/images/projects/project-01/mobile mockup.png" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    preview={<Media src="/images/projects/project-01/mobile mockup.png" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codes={[
      {
        code:
`<Media
