...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:merwinvilvar626@gmail.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Merwin Vilvar's Portfolio",
    description: "Portfolio website showcasing my work as a Shopify Partner",
    headline: <>Shopify Developer</>,
    subline: (
      <>
        I'm Merwin, a Shopify Developer at <InlineCode>FLY</InlineCode>, where I craft intuitive
